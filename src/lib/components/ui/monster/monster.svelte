...
<Card>
	<Card onclick={() => collapse = !collapse}>
		<h5
		...
		{/if}
		<span>
			Health:  {adjustableHealth} / {npc.hp}  ({Math.floor((adjustableHealth/npc.hp) * 100)}%)
		</span>
		</Card
	>
	<br />
	...
	<div class="grid grid-cols-3 gap-4">
		<div class="text-center">
			...
			<p class="font-normal text-gray-700 dark:text-gray-400">{npc.hp}</p>
			<input
				type="number"
		...
		<div class="text-center">
			...
			<p class="font-normal text-gray-700 dark:text-gray-400">{npc.ac}</p>
		</div>
		<div class="text-center">
			<h6 class="text-lg font-semibold text-gray-900 dark:text-white">
				Movement
	...
	<p class="font-normal text-gray-700 dark:text-gray-400">
		This is a monster card. It can be used to display monster information.
	</p>
</span>
{/if}
</Card>
